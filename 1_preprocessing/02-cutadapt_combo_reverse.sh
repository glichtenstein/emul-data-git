...
WORKDIR="/home/cucher/BigData/sanger_RNAseq/01-reads/1-raw/reverse";
ADAPTERS="/home/cucher/BigData/sanger_RNAseq/01-reads/2-adapters/reverse";
OUT="/home/cucher/BigData/sanger_RNAseq/01-reads/3-preprocessed/reverse";
#
...
## Clean a little the $OUT folder
	...
	for fw in $OUT/polyA-NebNext-*; do rename 's/_2.fastq/.fastq/' $fw; done && \
	(( count++ ));
done
# Seguir pipeline con bbmerge y trimmomatic
#################################################################################################
qsub "/home/cucher/BigData/sanger_RNAseq/01-reads/03-bbmerge_and_trim_combo.sh"
